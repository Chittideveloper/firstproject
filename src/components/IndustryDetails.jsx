...
const IndustryDetails = () => {
    ...
    const allIndustryPagesData = [
        ...
        },
        {
            ...
            features: [
                {
                    icon: Users, // Replaced Smartphone
    ...
    const industry = allIndustryPagesData.find((i) => i.id === id);
